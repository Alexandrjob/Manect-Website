 ...
 */
   ...
   */
            function (e) {
                ...
                }, Y = /HTML$/i, J = /^(?:input|select|textarea|button)$/i, Q = /^h\d$/i, K = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = new RegExp("\\\\[\\da-fA-F]{1,6}" + R + "?|\\\\([^\\r\\n\\f])", "g"), ne = function (e, t) {
                        ...
                        le((function (o, a, s, u) {
                            var l, c, f, p = [], d = [], h = a.length, g = o || function (e, t, n) {
                                for (var r = 0, i = t.length; r < i; r++)
                                    se(e, t[r], n);
                                return n
                            }(t || "*", s.nodeType ? [s] : s, []), v = !e || !o && t ? g : Te(g, p, e, s, u), m = n ? i || (o ? e : h || r) ? [] : a : v;
                            if (n && n(v, m, s, u),
                                r)
                                for (l = Te(m, d),
                                    r(l, [], s, u),
                            ...
                            (s = k(e, function (e, t) {
                                var n = t.length > 0
                                    ...
                                    , o = function (o, a, s, u, c) {
                                        var f, h, v, m = 0, y = "0", x = o && [], b = [], w = l, C = o || i && r.find.TAG("*", c), E = T += null == w ? 1 : Math.random() || .1, S = C.length;
                    ...
                    var t = [["notify", "progress", C.Callbacks("memory"), C.Callbacks("memory"), 2], ["resolve", "done", C.Callbacks("once memory"), C.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", C.Callbacks("once memory"), C.Callbacks("once memory"), 1, "rejected"]]
                        ...
                        , i = {
                            ...
                            then: function (e, r, i) {
                                            ...
                                            , l = function () {
                                                ...
                                                if (!(e < o)) {
                                                    ...
                                                    l = n && ("object" == typeof n || "function" == typeof n) && n.then,
                                                        m(l) ? i ? l.call(n, a(o, t, I, i), a(o, t, F, i)) : (o++,
                                                            l.call(n, a(o, t, I, i), a(o, t, F, i), a(o, t, I, t.notifyWith))) : (r !== I && (s = void 0,
                                                                u = [n]),
                                                                (i || t.resolveWith)(s, u))
                                                }
                                            }
                                ...
                                return C.Deferred((function (n) {
                                    t[0][3].add(a(0, n, m(i) ? i : I, n.notifyWith)),
        ...
        C.event = {
            ...
            special: {
                ...
                click: {
                    setup: function (e) {
                        var t = this || e;
                        return ge.test(t.type) && t.click && j(t, "input") && De(t, "click", ke),
                            !1
                    },
                    trigger: function (e) {
                        var t = this || e;
                        return ge.test(t.type) && t.click && j(t, "input") && De(t, "click"),
                            !0
                    },
                    _default: function (e) {
                        var t = e.target;
            ...
            if (p && (o = (i = Te(t, e[0].ownerDocument, !1, e, r)).firstChild,
                ...
                if (s)
                    for (c = a[a.length - 1].ownerDocument,
                        ...
                        f = 0; f < s; f++)
                        l = a[f],
                            me.test(l.type || "") && !Q.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {
        ...
        function Ue(e, t, n) {
            ...
            return (n = n || $e(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || ae(e) || (a = C.style(e, t)),
                !v.pixelBoxStyles() && Be.test(a) && ze.test(t) && (r = s.width,
                    i = s.minWidth,
                    o = s.maxWidth,
        ...
        function rt(e, t, n) {
            ...
            return (!v.boxSizingReliable() && i || !v.reliableTrDimensions() && j(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === C.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === C.css(e, "boxSizing", !1, r),
                (o = s in e) && (a = e[s])),
        ...
        C.extend({
            ...
            C.each(["height", "width"], (function (e, t) {
                C.cssHooks[t] = {
                    get: function (e, n, r) {
                        if (n)
                            return !Qe.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? rt(e, t, r) : _e(e, Ze, (function () {
                                return rt(e, t, r)
                            }
                            ))
                    },
                    set: function (e, n, r) {
                        var i, o = $e(e), a = !v.scrollboxSize() && "absolute" === o.position, s = (a || r) && "border-box" === C.css(e, "boxSizing", !1, o), u = r ? nt(e, t, r, s, o) : 0;
        ...
        C.extend(C.event, {
            trigger: function (e, t, r, i) {
                ...
                if (a = p = s = r = r || x,
                    ...
                    return e.type = g,
                        i || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(h.pop(), t) || !Y(r) || l && m(r[g]) && !y(r) && ((s = r[l]) && (r[l] = null),
                            C.event.triggered = g,
            ...
            C.extend({
                ...
                ajax: function (e, t) {
                    "object" == typeof e && (t = e,
                        e = void 0),
                        t = t || {};
                    var r, i, o, a, s, u, l, c, f, p, d = C.ajaxSetup({}, t), h = d.context || d, g = d.context && (h.nodeType || h.jquery) ? C(h) : C.event, v = C.Deferred(), m = C.Callbacks("once memory"), y = d.statusCode || {}, b = {}, w = {}, T = "canceled", E = {
                        readyState: 0,
                    ...
                    if (v.promise(E),
                        d.url = ((e || d.url || Et.href) + "").replace(Rt, Et.protocol + "//"),
